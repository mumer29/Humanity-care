            ...
            <div className="container " 
             >
                <div className="row  justify-content-center align-items-center py-3 ">
                    <div className="col-lg-2 col-sm-12 col-md-12 text-center  " style={{ height: "40px" }}>
                        <h5 style={{ height: "100%", width: "100%", lineHeight: "40px", color:"white" }}>QUICK DONATE</h5>
                    </div>
                    <div className="col-lg-3 col-md-4 text-center " style={{ height: "40px" }}>
                    ...
                    <div className="col-lg-2 col-md-4 text-center  " style={{ height: "40px" }}>
                        <div  
                    ...
                    <div className="col-lg-2 text-center col-sm-12 col-md-6  " style={{ height: "40px" }}>
